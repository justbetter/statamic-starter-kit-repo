...
@if($link && $link['link']?->value())
    <x-rapidez::tag
        ...
        :rel="!$disable && $link['link']->value() && $link['link_options'] && $link->link_options['rel'] ? $link->link_options['rel']->value() : null"
        ...
        :download="!$disable && $link['link']->value() && $link['link_options'] && $link->link_options['download_attribute'] ? '' : false"
        {{ $attributes }}
    >
        {{ $slot }}
    </x-rapidez::tag>
